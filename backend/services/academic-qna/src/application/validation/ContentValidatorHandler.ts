...
const FORBIDDEN_WORDS = ['spam', 'violencia', 'odio', 'racismo', 'discriminación', 'pornografía', 'drogas', 'armas', 'idiota', 'estupido', 'insulto', 'tonto', 'perra', 'marica', 'hp', 'hpta', 'puto', 'puta'];
