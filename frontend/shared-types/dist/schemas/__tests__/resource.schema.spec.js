...
import { StudyResourceDTOSchema, StudyResourceSchema, } from "../resource.schema.js";
...
describe("resource.schema", () => {
    ...
    it("accepts a valid StudyResource DTO and transforms snake_case to camelCase", () => {
        ...
        if (dtoResult.success) {
            ...
            expectTypeOf(camel.uploaderUserId).toEqualTypeOf();
            expectTypeOf(camel.subjectId).toEqualTypeOf();
            expectTypeOf(camel.createdAt).toEqualTypeOf();
            expectTypeOf(camel.updatedAt).toEqualTypeOf();
            expectTypeOf(camelUploader).toEqualTypeOf();
            expectTypeOf(camelSubject).toEqualTypeOf();
...
//# sourceMappingURL=resource.schema.spec.js.map