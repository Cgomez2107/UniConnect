...
import { StudyGroupSchema, StudyGroupDTOSchema, StudyGroupMemberSchema, StudyGroupMemberDTOSchema, StudyApplicationSchema, StudyApplicationDTOSchema, } from "../study-group.schema.js";
...
describe("study-group.schema", () => {
    ...
    describe("StudyGroupMemberDTOSchema", () => {
        it("accepts a valid StudyGroupMember DTO payload", () => {
            const result = StudyGroupMemberDTOSchema.safeParse(validStudyGroupMemberDto);
            expect(result.success).toBe(true);
            if (result.success) {
                expect(result.data.role).toBe("admin");
                expectTypeOf(result.data).toEqualTypeOf();
        ...
        it("transforms StudyGroupMember DTO with snake_case to camelCase mapping", () => {
            const dtoResult = StudyGroupMemberDTOSchema.safeParse(validStudyGroupMemberDto);
            if (dtoResult.success) {
                const transformed = snakeToCamel(dtoResult.data);
    ...
    describe("StudyApplicationDTOSchema", () => {
        it("accepts a valid StudyApplication DTO payload", () => {
            const result = StudyApplicationDTOSchema.safeParse(validStudyApplicationDto);
            expect(result.success).toBe(true);
            if (result.success) {
        ...
        it("transforms StudyApplication DTO with snake_case to camelCase mapping", () => {
            const dtoResult = StudyApplicationDTOSchema.safeParse(validStudyApplicationDto);
            if (dtoResult.success) {
                const transformed = snakeToCamel(dtoResult.data);
...
//# sourceMappingURL=study-group.schema.spec.js.map