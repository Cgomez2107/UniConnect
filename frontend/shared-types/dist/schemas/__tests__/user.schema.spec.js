...
import { FacultyDTOSchema, FacultySchema, ProfileDTOSchema, ProfileSchema, ProgramDTOSchema, ProgramSchema, SubjectDTOSchema, SubjectSchema, UserProgramDTOSchema, UserSubjectDTOSchema, } from "../user.schema.js";
...
describe("user.schema", () => {
    ...
    it("accepts a valid Profile DTO and transforms snake_case to camelCase", () => {
        ...
        if (dtoResult.success) {
            ...
            expectTypeOf(camel.firstName).toEqualTypeOf();
            expectTypeOf(camel.lastName).toEqualTypeOf();
            expectTypeOf(camel.createdAt).toEqualTypeOf();
            expectTypeOf(dtoResult.data).toEqualTypeOf();
        }
    });
    it("accepts and rejects Faculty schema payloads as expected", () => {
        ...
        if (validResult.success) {
            expectTypeOf(validResult.data).toEqualTypeOf();
        }
        if (validDtoResult.success) {
            expectTypeOf(validDtoResult.data).toEqualTypeOf();
        }
    });
    it("accepts Program and Subject schemas and DTO transformations", () => {
        ...
        if (programResult.success && subjectResult.success && programDtoResult.success && subjectDtoResult.success) {
            ...
            expectTypeOf(programResult.data).toEqualTypeOf();
            expectTypeOf(subjectResult.data).toEqualTypeOf();
            expectTypeOf(programCamel.facultyId).toEqualTypeOf();
            expectTypeOf(subjectCamel.programId).toEqualTypeOf();
            expectTypeOf(programDtoResult.data).toEqualTypeOf();
            expectTypeOf(subjectDtoResult.data).toEqualTypeOf();
        }
    });
    it("accepts UserSubject and UserProgram DTOs and preserves nested shape", () => {
        ...
        if (userSubjectResult.success && userProgramResult.success) {
            ...
            expectTypeOf(userSubjectResult.data).toEqualTypeOf();
            expectTypeOf(userProgramResult.data).toEqualTypeOf();
            expectTypeOf(userSubjectCamel.userId).toEqualTypeOf();
            expectTypeOf(userSubjectCamel.subjectId).toEqualTypeOf();
            expectTypeOf(userSubjectCamel.enrolledAt).toEqualTypeOf();
            expectTypeOf(userProgramCamel.userId).toEqualTypeOf();
            expectTypeOf(userProgramCamel.programId).toEqualTypeOf();
            expectTypeOf(userProgramCamel.enrolledAt).toEqualTypeOf();
            expectTypeOf(nestedSubject).toEqualTypeOf();
            expectTypeOf(nestedProgram).toEqualTypeOf();
        }
    });
});
