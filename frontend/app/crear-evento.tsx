...
export default function CreateEventScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      await repo.create(userId, payload)
      Alert.alert("Evento creado", "Tu evento se guardó como borrador.", [
  ...
  }, [title, description, eventDate, location, category, maxCapacity, userId])
  ...
  return (
    <View style={[styles.safe, { backgroundColor: C.background, paddingTop: insets.top }]}>
      ...
      <View style={[styles.header, { borderBottomColor: C.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: C.textPrimary }]}>Crear Evento</Text>
      </View>
